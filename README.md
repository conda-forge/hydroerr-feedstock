About hydroerr-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hydroerr-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/BYU-Hydroinformatics/HydroErr
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6114&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hydroerr-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hydroerr` can be installed with `conda`:
...
```
mamba install hydroerr
```

It is possible to list all of the versions of `hydroerr` available on your platform with `conda`:
...
```
mamba search hydroerr --channel conda-forge
```
...
mamba repoquery search hydroerr --channel conda-forge

# List packages depending on `hydroerr`:
mamba repoquery whoneeds hydroerr --channel conda-forge

# List dependencies of `hydroerr`:
mamba repoquery depends hydroerr --channel conda-forge
```
